...
def create_pkt (frame_size = 9000, direction=0):
    ...
    ip_range = {'src': {'start': "16.0.0.1", 'end': "16.0.0.254"},
                'dst': {'start': "10.0.2.100",  'end': "10.0.2.107"}}
    ...
    vm = [
        ...
        STLVmFlowVar(name="src_port", min_value=1025, max_value=1125, size=2, op="random"),
        STLVmWrFlowVar(fv_name="src_port",pkt_offset= "UDP.sport"),
        STLVmFlowVar(name="dst_port", min_value=1025, max_value=1125, size=2, op="random"),
